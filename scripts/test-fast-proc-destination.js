...
assert(handoff.includes('RECOMENDAÇÃO DO SETOR:'), 'FAST PROC destino: deve mostrar o setor recomendado')
assert(handoff.includes('PRESSIONE SETA PARA BAIXO E ENTER PARA FIXAR'), 'FAST PROC destino: deve orientar a sequência manual correta')
