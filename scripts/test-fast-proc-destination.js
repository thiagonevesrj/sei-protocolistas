...
assert(handoff.includes('function pressEnter (element)'), 'FAST PROC destino: deve confirmar a unidade com Enter')
assert(handoff.includes('pressEnter(select)'), 'FAST PROC destino: opção selecionada deve ser fixada na lista do SEI')
