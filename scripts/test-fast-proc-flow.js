...
function testFastMailProgressiveNavigation () {
  ...
  assert.ok(source.includes('1. ÁREA'))
  assert.ok(source.includes('2. ASSUNTO'))
  assert.ok(source.includes('3. AÇÃO'))
  ...
  assert.ok(source.includes("const PRIORITY_AREA_ORDER = ['habilitacao', 'veiculos', 'taxas', 'oficios']"))
